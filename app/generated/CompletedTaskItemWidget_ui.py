...
class Ui_CompletedTaskItemWidget:
    def setupUi(self, CompletedTaskItemWidget):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(
            QtGui.QPixmap("resources/views/../images/new-48.png"),
        ...
        self.btn_open_reminder = QtWidgets.QToolButton(parent=CompletedTaskItemWidget)
    ...
    def retranslateUi(self, CompletedTaskItemWidget):
        ...
        CompletedTaskItemWidget.setWindowTitle(
            _translate("CompletedTaskItemWidget", "Form")
        )
        self.btn_task_reopen.setText(_translate("CompletedTaskItemWidget", "..."))
        self.btn_open_reminder.setText(_translate("CompletedTaskItemWidget", "📱"))
        self.btn_open_reminder.setToolTip(
            _translate("CompletedTaskItemWidget", "Open in Reminders")
        )
